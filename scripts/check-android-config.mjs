...
/*
 * Billing and in-app updates are plugins in this module rather than npm packages,
 * which buys directness and costs the two guarantees a package would have given.
 ...
 * a store that reports itself unavailable, or an install that never updates itself.
 */
